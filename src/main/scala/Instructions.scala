...
object Instructions {
  ...
  //DFC Extension
  def TWA    = BitPat("b0000000??????????000000001110100")
  //def TRA    = BitPat("b0000000??????????010000001110100")

  //TWD addr
  def TWD_AD = BitPat("b0000000??????????001000001110100")
  //TWD info
  def TWD_IF = BitPat("b0000000??????????010000001110100")
